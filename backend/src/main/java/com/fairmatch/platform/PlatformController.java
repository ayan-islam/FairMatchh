...
class PlatformController {
    ...
    @PostMapping("/api/admin/organizations/{id}/verification/cancel") PlatformService.Organization cancelVerification(@PathVariable String id,@Valid @RequestBody PlatformService.OrganizationVerificationAction r,Principal p){return platform.cancelVerification(id,r.expectedVersion(),r.reason(),p.getName());}
    @PostMapping("/api/admin/organizations/{id}/verification/reopen") PlatformService.Organization reopenVerification(@PathVariable String id,@Valid @RequestBody PlatformService.OrganizationVerificationAction r,Principal p){return platform.reopenVerification(id,r.expectedVersion(),r.reason(),p.getName());}
